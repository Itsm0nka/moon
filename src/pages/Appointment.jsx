    ...
    docInfo && (
      <div>
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white dark:bg-[#014894] dark:border-gray-700 mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
            ...
            <div className="flex items-center gap-2 text-sm mt-1 text-gray-600 dark:text-gray-300">
              ...
              <button className="py-0.5 px-2 border text-xs rounded-full dark:border-gray-500">
                {docInfo.experience}
              </button>
            </div>
            <div>
        ...
        <div className="sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700 dark:text-white">
              ...
              docSlots[slotIndex].map((item, index) => (
                <p
                  ...
                  className={`text-sm font-light flex-shrink-0 px-5 py-2 rounded-full cursor-pointer ${
                    item.time === slotTime
                      ? "bg-[#5f6FFF] text-white"
                      : "text-gray-400 border border-gray-300 dark:border-gray-600 dark:text-gray-300"
                  }`}
                >
          ...
          <button className="bg-[#5f6FFF] text-sm text-white font-light px-14 py-3 rounded-full my-6">
            {t('bookAppointment')}
          </button>
        </div>
